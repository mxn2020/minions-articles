...
/**
 * @minions-articles/cli — CLI for Minions Articles
 *
...
import { customTypes } from '@minions-articles/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Articles'));
        console.log(chalk.dim('Article drafts, revisions, SEO metadata, and publish status'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-articles/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-articles/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-articles')}`);
