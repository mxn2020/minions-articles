# Manual Setup Steps for Minions Articles
...
Go to **GitHub → mxn2020/minions-articles → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-articles` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-articles-web`
- **GitHub repo**: `mxn2020/minions-articles`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `articles.minions.wtf`

### Documentation
- **Netlify site name**: `minions-articles-docs`
- **GitHub repo**: `mxn2020/minions-articles`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `articles.minions.help`

### Blog
- **Netlify site name**: `minions-articles-blog`
- **GitHub repo**: `mxn2020/minions-articles`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `articles.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `articles.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `articles.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `articles.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-articles/sdk`](https://www.npmjs.com/package/@minions-articles/sdk)
- CLI: [`@minions-articles/cli`](https://www.npmjs.com/package/@minions-articles/cli)
...
Your package: [`minions-articles`](https://pypi.org/project/minions-articles/)
...
| Item | Value |
|------|-------|
| Project | `minions-articles` |
| SDK (npm) | `@minions-articles/sdk` |
| CLI (npm) | `@minions-articles/cli` |
| Python (PyPI) | `minions-articles` |
| GitHub | `github.com/mxn2020/minions-articles` |
| Docs domain | `articles.minions.help` |
| Blog domain | `articles.minions.blog` |
| App domain | `articles.minions.wtf` |
